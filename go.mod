...
// UNVERIFIED IN SANDBOX: this sandbox has no Go toolchain and no network access,
// so these dependencies could not be fetched or compiled here. Run `go mod tidy`
// on your own machine to resolve versions and populate go.sum.
require (
...
replace gopkg.in/yaml.v2 => /home/claude/work/vendor/gopkg.in_yaml.v2

replace gopkg.in/yaml.v3 => /home/claude/work/vendor/gopkg.in_yaml.v3

replace gopkg.in/check.v1 => /home/claude/work/vendor/gopkg.in_check.v1

replace gopkg.in/errgo.v2 => /home/claude/work/vendor/gopkg.in_errgo.v2
